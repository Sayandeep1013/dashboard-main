...
export default function MissionComponent({user_type}:UserType) {
    ...
    const handleStatusUpdate = async (
        ...
        try {
            ...
            setConfirmationModal({
                show: true,
                type: action,
                message: `Mission has been ${action === "approve" ? "approved" : "rejected"
                    } successfully!`,
            });
                    ...
                    <div className="card shadow-sm border-0 mt-2">
                        <div className="card-body overflow-x-scroll">
                            <h5 className="card-title mb-4">
                                {`Results- ${totalRows} ${user_type === 5 ? "Teachers" : "Students"} found`}
                            </h5>
                            {isTableLoading ? (
